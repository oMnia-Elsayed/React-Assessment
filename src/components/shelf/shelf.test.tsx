...
describe('Shelf Component', () => {
    ...
    test('shelf is rendered correctly', () => {

        render(<Provider store={store}><BrowserRouter><Shelf shelf={shelfData}/></BrowserRouter></Provider>);

        expect(screen.getByText('Want to read').textContent).toEqual(shelfData.title);
